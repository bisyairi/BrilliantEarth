...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            ...
            'images' => '["products\/dummy\/FYB-Sapphire-Ring-1_1600x.jpg","products\/dummy\/FYB-Sapphire-Ring-2_1583x.jpg","products\/dummy\/FYB-Sapphire-Ring-3_1600x.jpg"]',
            'new_trend' => '1',
            'status' => '',
            'status_desc' => '',
        ])->categories()->attach(1);
        ...
        Product::create([
            ...
            'images' => '["products\/dummy\/Topaz-Love-Earrings_1349x.png","products\/dummy\/Petite-Paradise-Model-WEB-_5_aa3b4dd9-11a5-4a17-b40e-8fa578de4ec5_1349x.png"]',
            'new_trend' => '0',
            'status' => '',
            'status_desc' => '',
        ])->categories()->attach(4);
